<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">MySmartRestaurant</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/MySmartRestaurant" class="hvr-grow">Home</a></li>
		        <li><a href="/MySmartRestaurant/about-restro-girls.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/MySmartRestaurant">Home</a></li>
	        <li><a href="/MySmartRestaurant/about-restro-girls.php">About Us</a></li>
